...
class Damco_Wkhtmltopdf
{
   ...
   // protected $_bin = 'D:\\xampp\\htdocs\\triumph\\wkhtmltopdf\\bin\\wkhtmltopdf.exe';
    ...
    protected function _getCommand()
    {
       ...
       // $command .=  "  --print-media-type" ;  
        ...
        $command .= " --header-html " . HTTP_PATH."/chartSVGFiles/header.html";
       // $command .= "  --print-media-type  ";
        $command .= " --stop-slow-scripts";
        $command .= " --disable-external-links";        
        $command .= "  --user-style-sheet ".HTTP_PATH."/css/pdf.css";        
       ...
       // $command .= " --footer-font-size 8 ";
        ...
        if ($this->getRunInVirtualX()) {
            $command = "xvfb-run  --server-args=\"-screen 4, 1280x1024x24\" " . $command;
        }
        //echo $command;die;
        return $command;
    }
