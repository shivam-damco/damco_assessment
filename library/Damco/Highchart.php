...
class Damco_Highchart implements \ArrayAccess
{
    //The chart type.
    //A regullar higchart
    const HIGHCHART = 0;
    ...
    {
        return Damco_HighchartOptionRenderer::render($this->_options);
    }
    ...
    {
        $this->_options[$offset] = new Damco_HighchartOption($value);
    }
    ...
    public function offsetGet($offset)
    {
        if (!isset($this->_options[$offset])) {
            $this->_options[$offset] = new Damco_HighchartOption();
        }
