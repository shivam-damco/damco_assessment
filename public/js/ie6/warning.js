...
function e(str) 
{
  ...
  //  _lit4.setAttribute('id','_lit4');
    ...
    _hd.style.fontSize = "1.3em";_hd.style.marginBottom = "0.5em";
    _hd.style.color = "#333";_hd.style.fontFamily = "Helvetica,Arial,sans-serif";
  ...
  //  var _ico4d = document.getElementById('_ico4');
   ...
   // var _ico4ds = _ico4d.style;
    var _ico5ds = _ico5d.style;_ico1ds.width = _ico2ds.width = _ico3ds.width =/* _ico4ds.width = */_ico5ds.width = "100px";
   ...
   // _ico4ds.background = "transparent url('"+imgPath+"browser_opera.gif') no-repeat scroll left top";
    ...
    _lit1.appendChild(document.createTextNode(br1));_lit2.appendChild(document.createTextNode(br2));
    _lit3.appendChild(document.createTextNode(br3));//_lit4.appendChild(document.createTextNode(br4));
